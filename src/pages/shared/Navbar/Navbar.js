...
const Navbar = () => {
  ...
  <NavLink to="/Home">
          ...
          <li className={`${isActive ?'text-orange':'text-black'} hover:text-orange  font-bold list-none`}>Home</li>
          }
          </NavLink>
  <NavLink to="/login">
          {({ isActive })=>

          <li className={`${isActive ?'text-orange':'text-black'} hover:text-orange  font-bold list-none`}>Login</li>
          }
          </NavLink>
