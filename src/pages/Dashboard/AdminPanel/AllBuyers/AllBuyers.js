...
const AllBuyers = () => {
    ...
    const handleDelete = (user)=>{
      ...
      const confirmDelete = window.confirm(`would you like to delete ${user.email}`)
      if(confirmDelete){
        ...
        <div className='container mx-auto px-4 sm:px-8 py-8'>
          ...
          <div className='min-w-full shadow rounded-lg '>
              ...
              <tbody>
                ...
                {
                  users.map((buyer,i)=><BuyerInfo key={buyer._id} buyer={buyer} index={i} handleDelete={handleDelete}/>)
                }
